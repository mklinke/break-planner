...
public class BreakRepositoryP2P implements BreakRepository, BreakListener
{
   ...
   public BreakRepositoryP2P()
      throws IOException
   {
      this(new P2PGateway());
   }

   public BreakRepositoryP2P(P2PGateway gateway)
      throws IOException
   {
      ...
      final RemoteBreakListener remoteBreakListener)
   {
      if (remoteBreakListener == null)
      {
         throw new IllegalArgumentException(
            "remoteBreakListener must not be null");
      }
      ...
      throws IOException
   {
      ...
      hostedBreaks.add(gateway.registerService(
         newBreak.getUniqueName(),
         properties));
   }
